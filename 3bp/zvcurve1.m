...
v(1) = 2.0 * 1.5941913671;

% L2 libration point

v(2) = 2.0 * 1.5860980401;

% L3 libration point

v(3) = 2.0 * 1.5060758307;

% L4 and L5 libration points

v(4) = 2.0 * 1.4939963237;

v(5) = 2.0 * 1.4939963237;
...
switch icflg
    ...
    case 3
        ...
        [c, h] = contour(x, y, z, v(3), 'LineWidth', 1.5);
    ...
    case 4
        ...
        [c, h] = contour(x, y, z, v(4), 'LineWidth', 1.5);
...
contour (x, y, z, clevel, 'LineWidth', 1.5);
